...
MakeGAPDocDoc( "doc",     # path to the directory containing the main file
               "qsopt_ex-interface",    # the name of the main file (without extension)
               ...
               [ "../PackageInfo.g", "../gap/qsinterface.gd" ],
               "qsopt_ex-interface", # the name of the book used by GAP's online help
...
GAPDocManualLab( "qsopt_ex-interface" );;
